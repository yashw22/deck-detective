      ...
      <div className={styles.innerContainer}>
        ...
        <section className={styles.section}>
          ...
          {openSections.objective && (
            <p>
              The objective of the game is to determine the exact identity of
              the hidden card before your opponents by collecting clues, asking
            ...
            <>
              ...
              <ul className={styles.ul}>
                ...
                <li>
                  ...
                  <ul className={styles.ul}>
                    <li>
                      If it has 1 element, the player announces the count
                      matching the question to everyone.
                    </li>
                    <li>
                      If it has 2 elements, the responding player shows the
                      matching card privately to the asker and announces the
                      count to everyone.
                    </li>
                  </ul>
                </li>
              ...
              <h3>Note Taking</h3>
              <p>
                Players are encouraged to keep notes privately to track
        ...
        <section className={styles.section}>
          ...
          {openSections.winning && (
            <ul className={styles.ul}>
              <li>
                <strong>Guess the Hidden Card:</strong> Declare your guess on
                your turn. If correct, you win. If incorrect, you are
                eliminated.
              </li>
              <li>
